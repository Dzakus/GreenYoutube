...
public class Module implements IXposedHookLoadPackage {
	...
	public void handleLoadPackage(LoadPackageParam lpparam) throws Throwable {
		if(lpparam.packageName.equals(PKG_NAME_YOUTUBE)){
			sPref.reload();
			if(sPref.getBoolean(Common.KEY_HIDE_WATERMARK, Common.DEF_HIDE_WATERMARK)){
				...
				XposedHelpers.findAndHookMethod(ProviderClass, "query", Uri.class, String[].class, String.class,
					String[].class, String.class, new XC_MethodHook() {
						...
						protected void afterHookedMethod(MethodHookParam param) throws Throwable {
							boolean isEnabledHook = sPref.getBoolean(KEY_IS_BGOL_ENABLED, true);
							if (!isEnabledHook) {
								return;
							}
							...
							if (Common.equalsWithNulls(key, KEY_IS_BGOL_ENABLED)
									& Common.equalsWithNulls(uri, URI_GSERIVCES)) {
